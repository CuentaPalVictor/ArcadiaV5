...
function getErrorMessage(errorCode) {
    switch (errorCode) {
        ...
        case 'auth/operation-not-allowed':
            return 'Método de autenticación no habilitado. Contacta al administrador.';
        ...
        case 'auth/requires-recent-login':
            return 'Esta operación requiere autenticación reciente. Inicia sesión nuevamente.';
        ...
        // Error genérico
        default:
            return errorCode ? `Error: ${errorCode.replace('auth/', '').replace('firestore/', '')}` : 'Ha ocurrido un error inesperado. Inténtalo de nuevo.';
    }
}
